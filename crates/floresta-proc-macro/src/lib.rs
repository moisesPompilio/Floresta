...
///
/// assert_eq!(
///     RpcMethodSepOnly::GetBestBlockHash.as_str(),
///     "get_best_block_hash"
/// );
/// assert_eq!(
...
/// ```
///
/// Using a `#[repr(u8)]` enum to show the macro works with Rust enum metadata.
///
/// ```rust
/// use std::str::FromStr;
///
...
/// }
///
/// assert_eq!(Code::Good.as_str(), "good");
/// assert_eq!(Code::Good as u8, 7);
/// assert_eq!(Code::from_str("good"), Ok(Code::Good));
/// assert_eq!(Code::from_str("bad"), Ok(Code::Bad));
/// ```
#[proc_macro_attribute]
