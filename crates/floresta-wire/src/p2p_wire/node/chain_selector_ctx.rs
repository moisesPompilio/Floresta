        ...
        loop {
            ...
            match message {
                ...
                PeerMessages::Block(recv_block) => {
                    ...
                    self.enforce_block_structure_check(&recv_block, peer)?;
    ...
    async fn handle_peer_notification(
        ...
        match unhandled {
            ...
            PeerMessages::Block(block) => {
                // Enforce the block structure policy and check whether there is an
                // outstanding user request before proceeding.
